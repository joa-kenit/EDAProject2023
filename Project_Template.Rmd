...
water.cl.f <- Plot2.get("Chloride", "Fluoride")
print(water.cl.f)

#relationship BOD and DO
water.bod.do <- Plot2.get("Biochemical Oxygen Demand", "Dissolved Oxygen")
print(water.bod.do)

#relationship Temperature and Dissolved Oxygen (DO)
water.temp.do <- Plot2.get("Temperature", "Dissolved Oxygen")
print(water.temp.do)

#relationship Biochemical Oxygen Demand (BOD) and Organic Carbon
water.bod.oc <- Plot2.get("Biochemical Oxygen Demand", "Organic Carbon")
print(water.bod.oc)
...
water.nit.do <- Plot2.get("Nitrate + Nitrite as N", "Dissolved Oxygen")
print(water.nit.do)

#relationship total suspended solids + turbidity
water.tss.turb <- Plot2.get("Total Suspended Solids", "Turbidity")
print(water.tss.turb)

#relationship total suspended solid + conductivity
water.tss.cond <- Plot2.get("Total Suspended Solids", "Conductivity")
print(water.tss.cond)

#relationship phosphorus and nitrate
water.p.nit <- Plot2.get("Total Phosphorus", "Nitrate + Nitrite as N")
print(water.p.nit)

#relationship Total Kjeldahl Nitrogen and Nitrate+Nitrite Concentration
water.totnit.nit <- Plot2.get("Total Kjeldahl Nitrogen", "Nitrate + Nitrite as N")
print(water.totnit.nit)

#relationship Chloride and total suspended solid
water.cl.tss <- Plot2.get("Chloride", "Total Suspended Solids")
print(water.cl.tss)
...
leaflet() %>%
  ...
  addPolygons(data = huc14, weight = 1, opacity = 1, color = "black", fillOpacity = 0)%>% addProviderTiles(providers$Esri.NatGeoWorldMap)%>%addCircleMarkers(lng= stationData1$Longitude, lat = stationData1$Latitude,layerId = stationData1$Name,color = "blue")
```
